...
links:
    ...
    exp_html: https://github.com/ndrwhr/andrewhoyer/blob/master/experiments/rain.html
    exp_js_css: https://github.com/ndrwhr/andrewhoyer/tree/master/resources/exp_src/rain
...
If you haven't already seen my CSS/HTML Rain experiment I highly suggest you "check it out":{{page.links.rain}} before reading more. Or if you're stuck using an older browser, you can just watch the video below.
...
By the way, if you're planning on delving into an experiment using some of the latest technologies, I highly suggest you take a look at some feature detection libraries (personally I think "modernizr":{{page.links.modernizr}} is pretty cool). I didn't use one for this experiment as I was only dealing with a small subset of features, plus I was interested in learning how to do it myself.

h2. Links:

* Source for this experiment: "HTML":{{page.links.exp_html}} and "everything else":{{page.links.exp_js_css}}
