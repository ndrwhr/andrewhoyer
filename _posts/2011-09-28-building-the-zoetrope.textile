...
In my case I wanted to be able to create some pretty smooth animations so I decided to go with 24 frames, which meant 24 divs all rotated slightly. This as it turned out was extremely tedius and boring, so I ended up writing a small ruby script that generated a css file that contained something like this:
